...
#             "what is in front of me?": self._answer_in_front,
#             "tell me how many objects are present?": self._answer_count_objects,
#             "can you tell me what objects are here?": self._answer_in_front
#         }
#
...
#         if action in {"come", "comes", "enter", "enters"}:
#             return (
#                 f"Yes the {obj_name} has entered"
#                 if obj else f"No, {obj_name} is not entered right now"
#             )
#
#         if action in {"leave", "leaves", "left"}:
#             return (
#                 f"No, the {obj_name} is still inside the room."
#                 if obj else f"Yes, the {obj_name} has left the room."
#             )
#
...
#
#         return (
#             f"Yes, {', '.join(matches)} is/are {relation} {obj}."
...
#         if prop.lower() == "emotion" and value in {None, "none", "not_applicable"}:
#             return "Emotion is not applicable for this object."
#
#         return value
#
...
#         if m:
#             return (
#                 f"Yes, {m.group('obj')} is present."
#                 if self.resolve_object(m.group("obj"))
#                 else f"No, {m.group('obj')} is not present."
#             )
#
#         # ---------------- Counting (Specific Object) ----------------
...
#         if m:
#             return self.answer_count_container(
#                 m.group("obj"),
#                 m.group("container"),
#                 m.group("prep")
#             )
...
#                 m.group("rel2"), m.group("obj2"), count=True
#             )
#
#         # Properties
