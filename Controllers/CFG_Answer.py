...
import json
import sys
from config import QA_GRAMMAR_CFG_PATH
...
class CFGKGBasedQA:
    def __init__(self, kg_folder, cfg_path=None):
        if cfg_path is None:
            cfg_path = str(QA_GRAMMAR_CFG_PATH)
        self.kg_folder = kg_folder
    ...
    def build_parser(self):
        ...
        cfg_template = self.load_cfg()
        grammar_string = cfg_template.replace(
