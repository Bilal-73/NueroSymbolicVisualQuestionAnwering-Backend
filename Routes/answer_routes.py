...
from Controllers.TaskQuestions import TaskHandler
answer_routes = Blueprint("answer_routes", __name__)
...
answer_handler = AnswerHandler(cfg_model)
import re
hybrid_qa=HybridKGBasedQA(str(KG_DIR))
...
def ask_question(blind_id):
    ...
    try:
        ...
        for q in questions:
            # 1. Try Scene Handler
            print("Question going to ask function of task handler : ",q)
...
# def split_questions(question_text):
#     """
#     Splits compound questions using 'and' or commas.
#     Simple logic: split by ' and '
#     """
#     # Normalize
#     q_lower = question_text.lower().strip()
#
#     # Split by ' and '
#     parts = re.split(r'\s+and\s+', q_lower)
#
#     final_questions = []
#     for p in parts:
#         p = p.strip()
...
# def split_questions(question_text):
#     """
#     Splits compound questions using 'and'.
#     Normalizes punctuation: removes . ! ? and adds a single ?
#     """
